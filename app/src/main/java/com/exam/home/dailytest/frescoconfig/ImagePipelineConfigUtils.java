package com.exam.home.dailytest.frescoconfig;
...
public class ImagePipelineConfigUtils {
    ...
    private static final int MAX_SMALL_DISK_VERYLOW_CACHE_SIZE = 30 * ByteConstants.MB;
    ...
    //小图所放路径的文件夹名
    private static final String IMAGE_PIPELINE_SMALL_CACHE_DIR = "sunland_small_img";

    //默认图所放路径的文件夹名
    private static final String IMAGE_PIPELINE_CACHE_DIR = "sunland_large_img";
    ...
    public static ImagePipelineConfig getDefaultImagePipelineConfig(Context context) {
        ...
        //缓存图片配置
        ImagePipelineConfig.Builder configBuilder = OkHttpImagePipelineConfigFactory.newBuilder(context, OkHttpUtils.getInstance().getOkHttpClient())
